    ...
    <div className="max-w-sm mx-auto mt-12 bg-white rounded-lg border border-zinc-200 p-6">
      ...
      <form onSubmit={save} className="space-y-4">
        <input
          ...
          minLength={2}
          required
          className="w-full border border-zinc-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#335438]"
          autoFocus
        />
        <button
          disabled={busy}
          className="w-full bg-[#335438] text-white rounded-md py-2 font-medium hover:bg-[#27402b] disabled:opacity-50 cursor-pointer"
        >
