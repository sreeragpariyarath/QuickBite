...
- After adding endpoints, run `pnpm openapi` in the service to refresh `docs/openapi/*.openapi.json`. Postman is fed by importing these specs — never hand-edit Postman collections.
